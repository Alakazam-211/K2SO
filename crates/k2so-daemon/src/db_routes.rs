...
pub fn handle_projects_get_editors() -> CliResponse {
    ok_serialized(k2so_core::editors::get_installed_editors())
}

pub fn handle_projects_get_all_editors() -> CliResponse {
    ok_serialized(k2so_core::editors::get_all_editors())
}

pub fn handle_projects_refresh_editors() -> CliResponse {
    ok_serialized(k2so_core::editors::clear_editor_cache())
}
...
pub fn handle_projects_open_in_editor(body: &[u8]) -> CliResponse {
    ...
    unit_ok(k2so_core::editors::open_in_editor(&b.editor_id, &b.path))
}
...
pub fn handle_projects_open_in_terminal(body: &[u8]) -> CliResponse {
    ...
    unit_ok(k2so_core::editors::open_in_terminal(
        &b.terminal_app,
        &b.path,
    ))
}
