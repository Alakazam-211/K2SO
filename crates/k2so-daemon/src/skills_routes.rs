...
//! to.
//!
//! Each handler wraps the SAME `k2so_core` fn the Tauri command called,
...
use k2so_core::skills;
use k2so_core::skills::content::OptInSkill;
...
///
/// Wraps `k2so_core::skills::crud::create`. Returns the created
...
///
/// Wraps `k2so_core::skills::crud::remove`, which TRASHES the skill dir
...
///
/// Wraps `k2so_core::skills::content::write_opt_in_skill`. Writes one of
...
///
/// Wraps `k2so_core::workspace::onboarding::set_harness_fanout_enabled`,
...
pub fn handle_set_harness_fanout_enabled(body: &[u8]) -> CliResponse {
    ...
    match k2so_core::workspace::onboarding::set_harness_fanout_enabled(&b.project_path, b.enabled) {
        Ok(()) => CliResponse::ok_json(r#"{"success":true}"#.to_string()),
        Err(e) => CliResponse::bad_request(e),
    }
}
...
mod tests {
    ...
    fn set_harness_fanout_enabled_writes_marker() {
        ...
        assert!(
            k2so_core::workspace::onboarding::harness_fanout_enabled(&pp),
