...
| 4 — DB-direct writes | pending (task #527) | — | Wave C — last big unit. ~15 of Tauri's 34 SQL touchpoints; use F5 spawn_blocking for libgit2 ops. Method-gate rule MUST be inlined explicitly. |
...
| 7d — Residual k2so_agents.rs migration (~1,400 LoC) → k2so-core | pending (task #529) | — | Triage logic, regenerate_workspace_skill, save_agent_md, get_editor_context, workspace_session_*, workspace_relations_* + tests. Blocks final commands/k2so_agents.rs deletion. |
