...
Rust backend engineer — Tauri v2 commands, agent_hooks HTTP server, SQLite/rusqlite database, Alacritty terminal emulation, llama-cpp local LLM integration, libgit2 git/worktree operations, portable-pty management, state management, Cargo build system
...
5. When done: `k2so work move --agent rust-eng --file <task>.md --from active --to done`
